...
@section('decription','Dự đoán XSMB '.getNgay($dudoan->date).' chính xác từ cao thủ soi cầu số 1 hiện nay. Soi cầu xổ số miền Bắc chính xác 100, hoàn toàn miễn phí trên xosobadai.net')
