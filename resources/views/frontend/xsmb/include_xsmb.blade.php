...
@foreach ($xsmbs as $xsmb)
        ...
        <div class="box" id='kqngay_{{ getNgayID($xsmb->date) }}'>
                    ...
                    <table class="kqmb extendable">
                        <tbody>
                            ...
                            <tr class="db">
                                ...
                                <td class="v-giai number "><span data-nc="5" class="v-gdb " id="mb_prize_DB_item_0">
                                        @if (!empty($gdb))
                                            {{ $gdb }}
                                        @endif
                                    </span>
                            ...
                            <tr>
                                ...
                                <td class="v-giai number"><span data-nc="5" class="v-g1" id="mb_prize_1_item_0">
                                        @if (!empty($g1))
                                            {{ $g1 }}
                                        @endif
                                    </span>
                            ...
                            <tr class="bg_ef">
                                ...
                                <td class="v-giai number">
                                    <span data-nc="5" class="v-g2-0 " id="mb_prize_2_item_0">
                                        @if (!empty($g2[0]))
                                            {{ $g2[0] }}
                                        @endif
                                    </span><span data-nc="5" class="v-g2-1 " id="mb_prize_2_item_1">
                                        @if (!empty($g2[1]))
                                            {{ $g2[1] }}
                                        @endif
                                    </span>
                            ...
                            <tr>
                                ...
                                <td class="v-giai number">
                                    <span data-nc="5" class="v-g3-0 " id="mb_prize_3_item_0">
                                        @if (!empty($g3[0]))
                                            {{ $g3[0] }}
                                        @endif
                                    </span><span data-nc="5" class="v-g3-1 " id="mb_prize_3_item_1">
                                        @if (!empty($g3[1]))
                                            {{ $g3[1] }}
                                        @endif
                                    </span><span data-nc="5" class="v-g3-2 " id="mb_prize_3_item_2">
                                        @if (!empty($g3[2]))
                                            {{ $g3[2] }}
                                        @endif
                                    </span><span data-nc="5" class="v-g3-3 " id="mb_prize_3_item_3">
                                        @if (!empty($g3[3]))
                                            {{ $g3[3] }}
                                        @endif
                                    </span><span data-nc="5" class="v-g3-4 " id="mb_prize_3_item_4">
                                        @if (!empty($g3[4]))
                                            {{ $g3[4] }}
                                        @endif
                                    </span><span data-nc="5" class="v-g3-5 " id="mb_prize_3_item_5">
                                        @if (!empty($g3[5]))
                                            {{ $g3[5] }}
                                        @endif
                                    </span>
                            ...
                            <tr class="bg_ef">
                                ...
                                <td class="v-giai number">
                                    <span data-nc="4" class="v-g4-0 " id="mb_prize_4_item_0">
                                        @if (!empty($g4[0]))
                                            {{ $g4[0] }}
                                        @endif
                                    </span><span data-nc="4" class="v-g4-1 " id="mb_prize_4_item_1">
                                        @if (!empty($g4[1]))
                                            {{ $g4[1] }}
                                        @endif
                                    </span><span data-nc="4" class="v-g4-2 " id="mb_prize_4_item_2">
                                        @if (!empty($g4[2]))
                                            {{ $g4[2] }}
                                        @endif
                                    </span><span data-nc="4" class="v-g4-3 " id="mb_prize_4_item_3">
                                        @if (!empty($g4[3]))
                                            {{ $g4[3] }}
                                        @endif
                                    </span>
                            ...
                            <tr>
                                ...
                                <td class="v-giai number">
                                    <span data-nc="4" class="v-g5-0 " id="mb_prize_5_item_0">
                                        @if (!empty($g5[0]))
                                            {{ $g5[0] }}
                                        @endif
                                    </span><span data-nc="4" class="v-g5-1 " id="mb_prize_5_item_1">
                                        @if (!empty($g5[1]))
                                            {{ $g5[1] }}
                                        @endif
                                    </span><span data-nc="4" class="v-g5-2 " id="mb_prize_5_item_2">
                                        @if (!empty($g5[2]))
                                            {{ $g5[2] }}
                                        @endif
                                    </span><span data-nc="4" class="v-g5-3 " id="mb_prize_5_item_3">
                                        @if (!empty($g5[3]))
                                            {{ $g5[3] }}
                                        @endif
                                    </span><span data-nc="4" class="v-g5-4 " id="mb_prize_5_item_4">
                                        @if (!empty($g5[4]))
                                            {{ $g5[4] }}
                                        @endif
                                    </span><span data-nc="4" class="v-g5-5 " id="mb_prize_5_item_5">
                                        @if (!empty($g5[5]))
                                            {{ $g5[5] }}
                                        @endif
                                    </span>
                            ...
                            <tr class="bg_ef">
                                ...
                                <td class="v-giai number">
                                    <span data-nc="3" class="v-g6-0 " id="mb_prize_6_item_0">
                                        @if (!empty($g6[0]))
                                            {{ $g6[0] }}
                                        @endif
                                    </span><span data-nc="3" class="v-g6-1 " id="mb_prize_6_item_1">
                                        @if (!empty($g6[1]))
                                            {{ $g6[1] }}
                                        @endif
                                    </span><span data-nc="3" class="v-g6-2 " id="mb_prize_6_item_2">
                                        @if (!empty($g6[2]))
                                            {{ $g6[2] }}
                                        @endif
                                    </span>
                            ...
                            <tr class="g7">
                                ...
                                <td class="v-giai number">
                                    <span data-nc="2" class="v-g7-0 " id="mb_prize_7_item_0">
                                        @if (!empty($g7[0]))
                                            {{ $g7[0] }}
                                        @endif
                                    </span><span data-nc="2" class="v-g7-1 " id="mb_prize_7_item_1">
                                        @if (!empty($g7[1]))
                                            {{ $g7[1] }}
                                        @endif
                                    </span><span data-nc="2" class="v-g7-2 " id="mb_prize_7_item_2">
                                        @if (!empty($g7[2]))
                                            {{ $g7[2] }}
                                        @endif
                                    </span><span data-nc="2" class="v-g7-3 " id="mb_prize_7_item_3">
                                        @if (!empty($g7[3]))
                                            {{ $g7[3] }}
                                        @endif
                                    </span>
            ...
            <div class="see-more">
                ...
                <ul class="list-html-link two-column">
                    <li>Xem thêm <a href="{{ route('tk.lo-gan', 'mb') }}" title="thống kê lô gan miền Bắc">thống kê lô
                            gan miền Bắc</a></li>
                    <li>Tham gia <a href="{{ route('quay_thu.mb') }}" title="quay thử miền Bắc">quay thử miền Bắc</a>
                        để thử vận may
                    </li>
                    <li>Hãy soi <a href="{{ route('scmb.cau-bach-thu') }}" title="cầu bạch thủ miền Bắc">cầu bạch thủ
                            miền Bắc</a> để chọn bộ số ngon nhất
                    </li>
                    <li>Xem thêm bảng kết quả <a href="{{ route('xsmb.skq') }}" title="XSMB 30 ngày">XSMB 30 ngày</a>
                    </li>
                </ul>
            </div>
        </div>
    @else
        <div class="box">
            ...
            <div id="load_kq_mb_{{ $d - 1 }}">
                <div data-id="kq" class="one-city" data-region="1">
                    <table class="kqmb extendable">
                        <tbody>
                            <tr>
                                <td colspan="13" class="v-giai madb"><span
                                        class="v-madb">{{ str_replace('-', ' - ', $xsmb->madb) }}</span>
                                </td>
                            </tr>
                            <tr class="db">
                                <td class="txt-giai">ĐB</td>
                                ...
                                <td class="v-giai number">
                                    <span data-nc="5" class="v-g2-0 ">
                                        @if (!empty($g2[0]))
                                            {{ $g2[0] }}
                                        @endif
                                    </span><span data-nc="5" class="v-g2-1 ">
                                        @if (!empty($g2[1]))
                                            {{ $g2[1] }}
                                        @endif
                                    </span>
                                ...
                                <td class="v-giai number">
                                    <span data-nc="5" class="v-g3-0 ">
                                        ...
                                        @if (!empty($g3[1]))
                                            {{ $g3[1] }}
                                        @endif
                                    </span><span data-nc="5" class="v-g3-2 ">
                                        @if (!empty($g3[2]))
                                            {{ $g3[2] }}
                                        @endif
                                    </span><span data-nc="5" class="v-g3-3 ">
                                        @if (!empty($g3[3]))
                                            {{ $g3[3] }}
                                        @endif
                                    </span><span data-nc="5" class="v-g3-4 ">
                                        @if (!empty($g3[4]))
                                            {{ $g3[4] }}
                                        @endif
                                    </span><span data-nc="5" class="v-g3-5 ">
                                        @if (!empty($g3[5]))
                                            {{ $g3[5] }}
                                        @endif
                                    </span>
                                ...
                                <td class="v-giai number">
                                    <span data-nc="4" class="v-g4-0 ">
                                        @if (!empty($g4[0]))
                                            {{ $g4[0] }}
                                        @endif
                                    </span><span data-nc="4" class="v-g4-1 ">
                                        @if (!empty($g4[1]))
                                            {{ $g4[1] }}
                                        @endif
                                    </span><span data-nc="4" class="v-g4-2 ">
                                        @if (!empty($g4[2]))
                                            {{ $g4[2] }}
                                        @endif
                                    </span><span data-nc="4" class="v-g4-3 ">
                                        @if (!empty($g4[3]))
                                            {{ $g4[3] }}
                                        @endif
                                    </span>
                                ...
                                <td class="v-giai number">
                                    <span data-nc="4" class="v-g5-0 ">
                                        @if (!empty($g5[0]))
                                            {{ $g5[0] }}
                                        @endif
                                    </span><span data-nc="4" class="v-g5-1 ">
                                        @if (!empty($g5[1]))
                                            {{ $g5[1] }}
                                        @endif
                                    </span><span data-nc="4" class="v-g5-2 ">
                                        @if (!empty($g5[2]))
                                            {{ $g5[2] }}
                                        @endif
                                    </span><span data-nc="4" class="v-g5-3 ">
                                        @if (!empty($g5[3]))
                                            {{ $g5[3] }}
                                        @endif
                                    </span><span data-nc="4" class="v-g5-4 ">
                                        @if (!empty($g5[4]))
                                            {{ $g5[4] }}
                                        @endif
                                    </span><span data-nc="4" class="v-g5-5 ">
                                        @if (!empty($g5[5]))
                                            {{ $g5[5] }}
                                        @endif
                                    </span>
                                ...
                                <td class="v-giai number">
                                    <span data-nc="3" class="v-g6-0 ">
                                        @if (!empty($g6[0]))
                                            {{ $g6[0] }}
                                        @endif
                                    </span><span data-nc="3" class="v-g6-1 ">
                                        @if (!empty($g6[1]))
                                            {{ $g6[1] }}
                                        @endif
                                    </span><span data-nc="3" class="v-g6-2 ">
                                        @if (!empty($g6[2]))
                                            {{ $g6[2] }}
                                        @endif
                                    </span>
                                ...
                                <td class="v-giai number">
                                    <span data-nc="2" class="v-g7-0 ">
                                        @if (!empty($g7[0]))
                                            {{ $g7[0] }}
                                        @endif
                                    </span><span data-nc="2" class="v-g7-1 ">
                                        @if (!empty($g7[1]))
                                            {{ $g7[1] }}
                                        @endif
                                    </span><span data-nc="2" class="v-g7-2 ">
                                        @if (!empty($g7[2]))
                                            {{ $g7[2] }}
                                        @endif
                                    </span><span data-nc="2" class="v-g7-3 ">
                                        @if (!empty($g7[3]))
                                            {{ $g7[3] }}
                                        @endif
                                    </span>
            ...
            @if ($d == 1)
                <div class="see-more">
                    {{-- <div class="bold see-more-title">⇒ Ngoài ra bạn có thể xem thêm:</div> --}}
                    <ul class="list-html-link two-column">
                        <li>Xem ngay <a href="{{ route('dudoan.xsmb') }}" title="Dự đoán XSMB">Dự đoán XSMB</a> chính
                            xác nhất hôm nay</li>
                        <li>Tham gia soi <a href="{{ route('scmb.cau-bach-thu') }}" title="cầu bạch thủ XSMB">cầu
                                bạch thủ XSMB</a> nhanh nhất
                        </li>
                        <li>Trải nghiệm <a href="{{ route('quay_thu.mb') }}" title="quay thử XSMB">quay thử XSMB</a>
                            hôm nay có độ chính xác cao
                        </li>
                        <li>Xem bảng kết quả
                            <a href="{{ route('xsmb.skq') }}" title="XSMB 30 ngày">XSMB 30 ngày</a> gần nhất
                        </li>
                    </ul>
                </div>
            @endif
