...
@section('content')
    ...
    <div class="col-l">
        ...
        <div class="box-content" style="height: auto !important;">
            ...
            <h2 dir="ltr"><strong>Đánh lô trượt được bao nhiêu? tại xosobadai.net</strong></h2>
            ...
            <h2 dir="ltr"><strong>Kinh nghiệm chơi lô trượt {{$province->name}} với xosobadai.net :</strong></h2>
