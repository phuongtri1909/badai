...
@section('content')
    <div class="col-l">
        ...
        <button class="btn-see-more magb10 btn-viewmore" id="xem_them" value="Xem thêm" data-page="2" data-province="mt">Xem
          ...
          <p><span style="font-weight: 400;"><a title="Sớ Đầu Đu&ocirc;i Miền Trung" href="/so-dau-duoi-xsmn"><strong>Sớ Đầu Đu&ocirc;i Miền Trung</strong></a>. Xem Sớ Đầu Đu&ocirc;i Miền Trung chuẩn nhất tại <a title="XoSobadai.net" href="/">XoSobadai.net</a></span></p>
            <p><span style="font-weight: 400;">XoSobadai.net nơi cập nhật Sớ Đầu Đu&ocirc;i Miền Trung ch&iacute;nh x&aacute;c v&agrave; nhanh ch&oacute;ng nhất.</span></p>
            ...
            <p><span style="font-weight: 400;">Xem Sớ Đầu Đu&ocirc;i, Sớ Đầu Đu&ocirc;i Miền Trung, Sớ Đầu Đu&ocirc;i Miền Nam, Sớ Đầu Đu&ocirc;i Miền Bắc được cập nhật li&ecirc;n tục, ch&iacute;nh x&aacute;c tại XoSobadai.net</span></p>
        ...
        $(document).ready(function () {
            ...
            $('#xem_them').click(function (event) {
                ...
                if (skip <= last_page) {
                    ...
                    $.post("{{route('sodauduoi.xsmt.xem_them')}}", {
