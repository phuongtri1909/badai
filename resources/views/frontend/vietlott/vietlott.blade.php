...
@section('title','Xổ Số Vietlott - XS Vietlott - KQXS Vietlott - Kết quả xổ số Vietlott hôm nay tại xosobadai.net')
...
@section('h1','Xổ Số Vietlott - XS Vietlott - KQXS Vietlott - Kết quả xổ số Vietlott hôm nay xosobadai.net')
...
@section('content')
    <div class="col-l">
        ...
        <div class="box-content">
                ...
                <p><span style="font-weight: 400;"><strong><a href="{{route('vietlott')}}" title="XS Vietlott"><span style="color:#0000FF"> Kết Quả XS Vietlott</span> </a></strong>. KQXS Vietlott. Kết Quả Xổ Số Vietlott. xosobadai.net nơi cập nhật Kết quả Xổ Số Vietlott nhanh v&agrave; ch&iacute;nh x&aacute;c nhất.</span></p>
            ...
            <p><span style="font-weight: 400;">Kết quả Xổ Số Vietlott được cập nhật li&ecirc;n tục, nhanh ch&oacute;ng v&agrave; ch&iacute;nh x&aacute;c tại xosobadai.net</span></p>
        </div>
    </div>
@endsection
