...
@section('title','Dự đoán XSMB Hôm Nay '.getNgay($dudoan->date).' - Dự đoán xổ số miền Bắc')
@section('decription','Dự đoán XSMB '.getNgay($dudoan->date).' - Dự đoán xổ số miền Bắc  - Thống kê, phân tích, dự đoán MB ngày '.getNgay($dudoan->date).' chốt số đẹp miễn phí hôm nay, tỷ lệ chuẩn xác 100%')
...
@section('h1','Dự đoán XSMB Hôm Nay '.getNgay($dudoan->date))
