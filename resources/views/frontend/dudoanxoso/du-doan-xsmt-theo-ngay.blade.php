            ...
            <div class="breadcrumb">
                <ol itemscope="" itemtype="https://schema.org/BreadcrumbList">
                    ...
                    <li itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem"><a
                                ...
                                title="Dự đoán XSMT {{getNgay($dudoan->date)}}" class="last"><span itemprop="name">Dự đoán XSMT {{getNgay($dudoan->date)}}</span>
...
@section('content')
    <div class="col-l" style="height: auto !important;">
        <ul class="tab-panel tab-auto">
            ...
            <li class="active"><a href="{{route('dudoan.xsmt')}}">Dự đoán MT</a></li>
