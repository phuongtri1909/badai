...
@section('content')
    <div class="col-l" style="height: auto !important;">
        ...
        <div class="box-content">
            <p>XSMT hôm nay - SXMT - XSMTR - <a style="text-decoration: underline" href="{{ route('xsmt') }}">xổ số miền Trung</a> hôm nay cập nhật mới nhất. xosobadai.net trực tiếp kết quả xổ
