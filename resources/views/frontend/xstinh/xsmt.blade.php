...
@section('content')
    <div class="col-l" style="height: auto !important;">
        ...
        @include('frontend.xstinh.include_xsmt')
        ...
        <div class="box-content">
            ...
            <p><span style="font-size:14px">XS {{$province->name }} - Trực tiếp kết quả <a
            ...
            <p>
                <span style="font-size:14px">
                    KQXS{{ strtoupper($province->short_name) }} được Công ty Xổ số kiến thiết {{ $province->name }} công
                    khai quay thưởng tại {{ $location }}.
                </span>
            </p>

            <p>
                <span style="font-size:14px">
                    Theo dõi xosobadai.net để xem <a style="text-decoration: underline" title="KQXS"
        ...
        $(document).ready(function() {
            ...
            $('#xem_them').click(function(event) {
                ...
                if (page <= last_page) {
                    ...
                    $.post("{{ route('xstinh.xsmt.xem_them') }}", {
