...
@section('title', 'Quay thử XSMN hôm nay - Quay thử xổ số miền Nam')
@section('decription', 'Quay thử XSMN thử vận may trước khi xem tường thuật kết quả xổ số. Bạn có thể quay thử Xổ số
    miền Nam hôm nay trước khi mua vé số kiến thiết MN.')
@section('h1', 'Quay thử XSMN hôm nay - Quay thử xổ số miền Nam')
        ...
        <div class="main">
            <div class="breadcrumb">
                <ol itemscope="" itemtype="https://schema.org/BreadcrumbList">
                    ...
                    <li itemprop="itemListElement" itemscope="" itemtype="https://schema.org/ListItem"><a itemprop="item"
                            href="{{ url()->current() }}" title="Quay thử XSMN" class="last"><span itemprop="name">Quay
                                thử XSMN</span>
        ...
        <div class="box-content">
            ...
            <ul class="list-html-link two-column">
                <li>Mời bạn <a href="{{ route('quay_thu.mn') }}" title="quay thử miền Nam">quay thử miền
                        Nam</a> XSMN hôm nay để lấy hên
                </li>
                <li>Xem thêm <a href="{{ route('xsmn') }}" title="Kết Quả XSMN">kết quả XSMN Xổ Số Miền
                        Nam </a></li>
                <li>Xem bảng kết quả <a href="{{ route('xsmn.skq') }}" title="XSMN 30 ngày gần nhất">XSMN
                        30 ngày gần nhất</a></li>
            </ul>
        </div>
        <div class="box-content">
            <h2 style="margin-bottom:25px"><strong>Quay Thử Xổ Số miền Nam Hôm Nay</strong></h2>
            <p style="margin: 0"><strong>Hướng Dẫn Sử Dụng</strong></p>
            <p style="margin: 0">Bước 1: Chọn đài “Quay thử miền Nam”.</p>
            ...
            <p style="margin: 0">Quay thử xổ số miền Nam hôm nay là một tính năng được xosobadai.net cung cấp. Kết quả quay thử
            ...
            <p style="margin: 0">Tính năng "Quay thử xổ số miền Nam" là một công cụ giải trí thú vị. Hãy sử dụng nó một cách vui vẻ và có trách nhiệm. Chúng tôi hoàn toàn không chịu trách nhiệm về việc Quý vị sử dụng thông tin này.
                Chúc các bạn MAY MẮN khi tham gia mua      
                <a style="text-decoration: underline" title="xổ số kiến thiết"
                    href="{{ route('home') }}">xổ số kiến thiết</a>.
            </p>
        </div>
    </div>
@endsection
